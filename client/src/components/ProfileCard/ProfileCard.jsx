...
import TextAttribute from '../EditableAttribute/TextAttribute';
import EnumAttribute from '../EditableAttribute/EnumAttribute';
                  ...
                  <Grid columns="equal">
                    ...
                    <Grid.Column>
                      <TextAttribute
                        ...
                        className="attribute"
                        onChange={onAttributeChange}
                        isDisabled={!userPermissions.edit.includes('gradYear')}
